...
import type { ObjectScript, PartObject } from '../studio/editorState'
import { setObjectScript } from '../studio/editorState'
...
export default function ObjectScriptEditor({ target, onClose }: Props) {
  ...
  return (
    <div className="obj-script-backdrop" onClick={onClose}>
      <div className="obj-script-modal" onClick={(e) => e.stopPropagation()}>
