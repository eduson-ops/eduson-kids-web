...
function NikselInner({
  ...
  // feetColor зарезервирован под будущий white-label override; пока используем BEAK
  // как универсальный, иначе TS ругается на unused. Удалить, когда подключим лапки.
  ...
  return (
    ...
    >
      ...
      {/* Feet — removed per design feedback (no foot animation, no feet) */}
