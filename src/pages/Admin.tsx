...
import { getClassrooms, createClassroom, deleteClassroom } from '../lib/classRoster'
...
export default function Admin() {
  ...
  const handleTransfer = () => {
    ...
    const raw = localStorage.getItem('ek_classrooms')
    ...
    try { localStorage.setItem('ek_classrooms', JSON.stringify(list)) } catch { /* quota */ }
    refresh()
    setSelectedLogin('')
