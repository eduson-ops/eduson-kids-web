...
const PSEUDONYMS = [
  'FireFox', 'CoolDragon', 'CodeKid', 'PythonMaster', 'BlockHero',
  'LoopKing', 'ScriptSage', 'LogicGuru', 'BitExplorer', 'CubeBuilder',
  'DataNinja', 'SyntaxStar', 'BugHunter', 'AlgoChamp', 'StackWiz',
  'ByteKnight', 'FuncSorcerer', 'ArrayGeek', 'CacheWolf', 'LambdaLion',
  'GitGuardian', 'CssCharmer', 'HtmlHacker', 'JsonJedi', 'RegexRanger',
  'ShellShark', 'TermTitan', 'VimViking', 'ZipZephyr', 'XmlXylo',
]
