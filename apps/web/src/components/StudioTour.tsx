...
export default function StudioTour() {
  ...
  return (
    <>
      ...
      {/* Tooltip */}
      <div className="tour-tip" style={tooltipPos} onClick={(e) => e.stopPropagation()}>
        <div className="tour-tip-head">
          <span className="tour-tip-step">Шаг {stepIdx + 1} / {STEPS.length}</span>
          <button className="tour-tip-close" onClick={finish} aria-label="Закрыть">×</button>
        </div>
