...
export const CATALOG: CatalogCategory[] = [
  ...
  {
    id: 'desert-oasis', name: 'Пустынный оазис', icon: '🏜',
    items: [
      { kind: 'sand-dune',        label: 'Песчаная дюна',       emoji: '🏔', defaultColor: '#d4a855', tags: ['дюна','sand dune','песок','пустыня','холм'], hint: 'Плавная песчаная дюна' },
      { kind: 'oasis-pool',       label: 'Оазисный бассейн',    emoji: '💧', defaultColor: '#44aacc', tags: ['бассейн','oasis pool','вода','пустыня','зелёный'], hint: 'Небольшой водоём в оазисе' },
      { kind: 'date-palm',        label: 'Финиковая пальма',    emoji: '🌴', defaultColor: '#558833', tags: ['пальма','date palm','финик','пустыня','дерево'], hint: 'Пальма с гроздьями фиников' },
      { kind: 'desert-tent',      label: 'Бедуинский шатёр',    emoji: '⛺', defaultColor: '#cc9944', tags: ['шатёр','desert tent','бедуин','кочевник','ткань'], hint: 'Красочный кочевой шатёр' },
      { kind: 'camel-statue',     label: 'Верблюд-статуя',      emoji: '🐪', defaultColor: '#c8a060', tags: ['верблюд','camel statue','статуя','пустыня','животное'], hint: 'Статуя верблюда из камня' },
      { kind: 'mirage-pillar',    label: 'Мираж-столп',         emoji: '🌀', defaultColor: '#88ccff', tags: ['мираж','mirage pillar','столп','иллюзия','пустыня'], hint: 'Зыбкий столп горячего воздуха' },
      { kind: 'desert-scorpion',  label: 'Скорпион',            emoji: '🦂', defaultColor: '#886633', tags: ['скорпион','desert scorpion','ядовитый','хвост','пустыня'], hint: 'Большой скорпион из камня' },
      { kind: 'nomad-brazier',    label: 'Кочевой жаровень',    emoji: '🔥', defaultColor: '#ff8800', tags: ['жаровень','nomad brazier','огонь','кочевник','тепло'], hint: 'Декоративный жаровень кочевника' },
      { kind: 'sandstone-arch',   label: 'Арка из песчаника',   emoji: '🏛', defaultColor: '#d4a855', tags: ['арка','sandstone arch','камень','ворота','пустыня'], hint: 'Природная арка из песчаника' },
      { kind: 'desert-skull',     label: 'Череп в пустыне',     emoji: '💀', defaultColor: '#e8ddc0', tags: ['череп','desert skull','кости','опасность','пустыня'], hint: 'Череп животного на песке' },
    ],
  },
  {
    id: 'medieval-castle', name: 'Средневековый замок', icon: '🏰',
    items: [
      { kind: 'castle-door',      label: 'Замковые двери',      emoji: '🚪', defaultColor: '#5a4030', tags: ['дверь','castle door','замок','деревянный','тяжёлый'], hint: 'Массивные двери замка с петлями' },
      { kind: 'drawbridge',       label: 'Подъёмный мост',      emoji: '🌉', defaultColor: '#8b6040', tags: ['мост','drawbridge','замок','ров','деревянный'], hint: 'Опущенный подъёмный мост' },
      { kind: 'knight-armor',     label: 'Доспех рыцаря',       emoji: '⚔', defaultColor: '#aabbcc', tags: ['доспех','knight armor','рыцарь','металл','стоит'], hint: 'Рыцарский доспех на подставке' },
      { kind: 'catapult-prop',    label: 'Катапульта',          emoji: '🏹', defaultColor: '#8b6020', tags: ['катапульта','catapult prop','осада','деревянная','средневековый'], hint: 'Деревянная катапульта готова к бою' },
      { kind: 'dungeon-door',     label: 'Дверь темницы',       emoji: '🔒', defaultColor: '#334433', tags: ['темница','dungeon door','решётка','железо','тюрьма'], hint: 'Железная дверь подземелья' },
      { kind: 'heraldic-banner',  label: 'Геральдический флаг', emoji: '🚩', defaultColor: '#cc2222', tags: ['флаг','heraldic banner','геральдика','замок','красный'], hint: 'Большой знаменный флаг с гербом' },
      { kind: 'arrow-slit',       label: 'Бойница',             emoji: '🏯', defaultColor: '#778899', tags: ['бойница','arrow slit','стена','замок','камень'], hint: 'Секция стены с бойницей' },
      { kind: 'wall-torch',       label: 'Настенный факел',     emoji: '🔦', defaultColor: '#ff6600', tags: ['факел','wall torch','огонь','стена','свет'], hint: 'Факел на каменной стене' },
      { kind: 'moat-water',       label: 'Ров с водой',         emoji: '💧', defaultColor: '#336688', tags: ['ров','moat water','вода','замок','ров'], hint: 'Участок рва с тёмной водой' },
