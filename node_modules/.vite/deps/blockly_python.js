...
import { t as require_blockly_compressed } from "./blockly_compressed-BM2tBZ3W.js";
var { Order, PythonGenerator, pythonGenerator } = (/* @__PURE__ */ __toESM((/* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(root, factory) {
		...
		var lists_create_empty$$module$build$src$generators$python$lists = function(a, b) {
			...
			return [(a.getFieldValue("END") === "FIRST" ? b.provideFunction_("first_index", `
...
`)) + "(" + d + ", " + c + ")", Order$$module$build$src$generators$python$python_generator.FUNCTION_CALL];
			...
			var e = b.valueToCode(a, "VALUE", d === "RANDOM" ? Order$$module$build$src$generators$python$python_generator.NONE : Order$$module$build$src$generators$python$python_generator.MEMBER) || "[]";
			switch (d) {
				case "FIRST":
					if (c === "GET") return [e + "[0]", Order$$module$build$src$generators$python$python_generator.MEMBER];
					if (c === "GET_REMOVE") return [e + ".pop(0)", Order$$module$build$src$generators$python$python_generator.FUNCTION_CALL];
					if (c === "REMOVE") return e + ".pop(0)\n";
					break;
				case "LAST":
					if (c === "GET") return [e + "[-1]", Order$$module$build$src$generators$python$python_generator.MEMBER];
					if (c === "GET_REMOVE") return [e + ".pop()", Order$$module$build$src$generators$python$python_generator.FUNCTION_CALL];
					if (c === "REMOVE") return e + ".pop()\n";
					break;
				case "FROM_START":
					a = b.getAdjustedInt(a, "AT");
					if (c === "GET") return [e + "[" + a + "]", Order$$module$build$src$generators$python$python_generator.MEMBER];
					if (c === "GET_REMOVE") return [e + ".pop(" + a + ")", Order$$module$build$src$generators$python$python_generator.FUNCTION_CALL];
					if (c === "REMOVE") return e + ".pop(" + a + ")\n";
					break;
				case "FROM_END":
				...
				case "RANDOM":
					...
					if (c === "GET") return ["random.choice(" + e + ")", Order$$module$build$src$generators$python$python_generator.FUNCTION_CALL];
					e = b.provideFunction_("lists_remove_random_item", `
def ${b.FUNCTION_NAME_PLACEHOLDER_}(myList):
  x = int(random.random() * len(myList))
  return myList.pop(x)
`) + "(" + e + ")";
					if (c === "GET_REMOVE") return [e, Order$$module$build$src$generators$python$python_generator.FUNCTION_CALL];
			...
			switch (e) {
				...
				case "FROM_END":
					...
					$.isNumber$$module$build$src$core$utils$string(String(a)) ? a === 0 && (a = "") : (b.definitions_.import_sys = "import sys", a += " or sys.maxsize");
					break;
				case "LAST":
					a = "";
					break;
			...
			a = a.getFieldValue("DIRECTION") === "1" ? "False" : "True";
...
`) + "(" + c + ", \"" + d + "\", " + a + ")", Order$$module$build$src$generators$python$python_generator.FUNCTION_CALL];
			...
			if (c === "SPLIT") c = b.valueToCode(a, "INPUT", Order$$module$build$src$generators$python$python_generator.MEMBER) || "''", a = b.valueToCode(a, "DELIM", Order$$module$build$src$generators$python$python_generator.NONE), a = c + ".split(" + a + ")";
			else if (c === "JOIN") c = b.valueToCode(a, "INPUT", Order$$module$build$src$generators$python$python_generator.NONE) || "[]", a = (b.valueToCode(a, "DELIM", Order$$module$build$src$generators$python$python_generator.MEMBER) || "''") + ".join(" + c + ")";
			else throw Error("Unknown mode: " + c);
			...
			do
				f = b.valueToCode(a, "IF" + c, Order$$module$build$src$generators$python$python_generator.NONE) || "False", e = b.statementToCode(a, "DO" + c) || b.PASS, b.STATEMENT_SUFFIX && (e = b.prefixLines(b.injectId(b.STATEMENT_SUFFIX, a), b.INDENT) + e), d += (c === 0 ? "if " : "elif ") + f + ":\n" + e, c++;
			while (a.getInput("IF" + c));
			if (a.getInput("ELSE") || b.STATEMENT_SUFFIX) e = a.getInput("ELSE") ? b.statementToCode(a, "ELSE") || b.PASS : b.PASS, b.STATEMENT_SUFFIX && (e = b.prefixLines(b.injectId(b.STATEMENT_SUFFIX, a), b.INDENT) + e), d += "else:\n" + e;
			return d;
			...
			const c = {
				...
				GT: ">",
				GTE: ">="
			}[a.getFieldValue("OP")], d = Order$$module$build$src$generators$python$python_generator.RELATIONAL, e = b.valueToCode(a, "A", d) || "0";
			a = b.valueToCode(a, "B", d) || "0";
			return [e + " " + c + " " + a, d];
		}, logic_operation$$module$build$src$generators$python$logic = function(a, b) {
			const c = a.getFieldValue("OP") === "AND" ? "and" : "or", d = c === "and" ? Order$$module$build$src$generators$python$python_generator.LOGICAL_AND : Order$$module$build$src$generators$python$python_generator.LOGICAL_OR;
			let e = b.valueToCode(a, "A", d);
			a = b.valueToCode(a, "B", d);
			e || a ? (b = c === "and" ? "True" : "False", e || (e = b), a || (a = b)) : a = e = "False";
			return [e + " " + c + " " + a, d];
			...
			return [a.getFieldValue("BOOL") === "TRUE" ? "True" : "False", Order$$module$build$src$generators$python$python_generator.ATOMIC];
			...
			var d = b.valueToCode(a, "FROM", Order$$module$build$src$generators$python$python_generator.NONE) || "0", e = b.valueToCode(a, "TO", Order$$module$build$src$generators$python$python_generator.NONE) || "0", f = b.valueToCode(a, "BY", Order$$module$build$src$generators$python$python_generator.NONE) || "1";
...
`);
			...
			if ($.isNumber$$module$build$src$core$utils$string(d) && $.isNumber$$module$build$src$core$utils$string(e) && $.isNumber$$module$build$src$core$utils$string(f)) d = Number(d), e = Number(e), f = Math.abs(Number(f)), d % 1 === 0 && e % 1 === 0 && f % 1 === 0 ? (d <= e ? (e++, a = d === 0 && f === 1 ? e : d + ", " + e, f !== 1 && (a += ", " + f)) : (e--, a = d + ", " + e + ", -" + f), a = "range(" + a + ")") : (a = d < e ? a() : k(), a += "(" + d + ", " + e + ", " + f + ")");
			else {
				...
				e = l(e, "_end");
				f = l(f, "_inc");
				typeof d === "number" && typeof e === "number" ? (a = d < e ? a() : k(), a += "(" + d + ", " + e + ", " + f + ")") : a = "(" + d + " <= " + e + ") and " + a() + "(" + d + ", " + e + ", " + f + ") or " + k() + "(" + d + ", " + e + ", " + f + ")";
			}
			return h += "for " + c + " in " + a + ":\n" + g;
			...
			return a === Infinity ? ["float(\"inf\")", Order$$module$build$src$generators$python$python_generator.FUNCTION_CALL] : a === -Infinity ? ["-float(\"inf\")", Order$$module$build$src$generators$python$python_generator.UNARY_SIGN] : [String(a), a < 0 ? Order$$module$build$src$generators$python$python_generator.UNARY_SIGN : Order$$module$build$src$generators$python$python_generator.ATOMIC];
			...
			let d;
			if (c === "NEG") return d = b.valueToCode(a, "NUM", Order$$module$build$src$generators$python$python_generator.UNARY_SIGN) || "0", ["-" + d, Order$$module$build$src$generators$python$python_generator.UNARY_SIGN];
			b.definitions_.import_math = "import math";
			a = c === "SIN" || c === "COS" || c === "TAN" ? b.valueToCode(a, "NUM", Order$$module$build$src$generators$python$python_generator.MULTIPLICATIVE) || "0" : b.valueToCode(a, "NUM", Order$$module$build$src$generators$python$python_generator.NONE) || "0";
			switch (c) {
				case "ABS":
					d = "math.fabs(" + a + ")";
					break;
				...
				case "COS":
					...
					break;
				case "TAN": d = "math.tan(" + a + " / 180.0 * math.pi)";
			}
			...
			a !== "INFINITY" && (b.definitions_.import_math = "import math");
			return c[a];
			...
			var c = {
				...
				PRIME: [
					...
					Order$$module$build$src$generators$python$python_generator.FUNCTION_CALL
				]
			};
			const d = a.getFieldValue("PROPERTY"), [e, f, g] = c[d];
			c = b.valueToCode(a, "NUMBER_TO_CHECK", f) || "0";
			if (d === "PRIME") b.definitions_.import_math = "import math", b.definitions_.from_numbers_import_Number = "from numbers import Number", a = b.provideFunction_("math_isPrime", `
def ${b.FUNCTION_NAME_PLACEHOLDER_}(n):
  ...
  return True
`) + "(" + c + ")";
			else if (d === "DIVISIBLE_BY") {
				a = b.valueToCode(a, "DIVISOR", Order$$module$build$src$generators$python$python_generator.MULTIPLICATIVE) || "0";
				if (a === "0") return ["False", Order$$module$build$src$generators$python$python_generator.ATOMIC];
				a = c + " % " + a + " == 0";
			} else a = c + e;
			return [a, g];
...
`) + "(" + a + ")";
			...
			for (var f of e) e = f.getName(), a.getVars().includes(e) || c.push(b.getVariableName(e));
			...
			let g = "";
			a.getInput("STACK") && (g = b.statementToCode(a, "STACK"));
			let h = "";
			a.getInput("RETURN") && (h = b.valueToCode(a, "RETURN", Order$$module$build$src$generators$python$python_generator.NONE) || "");
			let k = "";
			g && h && (k = f);
			...
			switch (a.itemCount_) {
				case 0: return ["''", Order$$module$build$src$generators$python$python_generator.ATOMIC];
				case 1: return a = b.valueToCode(a, "ADD0", Order$$module$build$src$generators$python$python_generator.NONE) || "''", forceString$$module$build$src$generators$python$text(a);
				case 2:
			...
			const c = a.getFieldValue("END") === "FIRST" ? "find" : "rfind", d = b.valueToCode(a, "FIND", Order$$module$build$src$generators$python$python_generator.NONE) || "''";
			...
			const c = a.getFieldValue("WHERE") || "FROM_START", d = b.valueToCode(a, "VALUE", c === "RANDOM" ? Order$$module$build$src$generators$python$python_generator.NONE : Order$$module$build$src$generators$python$python_generator.MEMBER) || "''";
			switch (c) {
				case "FIRST": return [d + "[0]", Order$$module$build$src$generators$python$python_generator.MEMBER];
				case "LAST": return [d + "[-1]", Order$$module$build$src$generators$python$python_generator.MEMBER];
				case "FROM_START": return a = b.getAdjustedInt(a, "AT"), [d + "[" + a + "]", Order$$module$build$src$generators$python$python_generator.MEMBER];
				case "FROM_END": return a = b.getAdjustedInt(a, "AT", 1, !0), [d + "[" + a + "]", Order$$module$build$src$generators$python$python_generator.MEMBER];
				case "RANDOM": return b.definitions_.import_random = "import random", [b.provideFunction_("text_random_letter", `
...
`);
			...
			c = c + "(" + b + ")";
			a.getFieldValue("TYPE") === "NUMBER" && (c = "float(" + c + ")");
		...
		var PythonGenerator$$module$build$src$generators$python$python_generator = class extends $.CodeGenerator$$module$build$src$core$generator {
			constructor(a = "Python") {
				...
				this.ORDER_OVERRIDES = [
					[Order$$module$build$src$generators$python$python_generator.FUNCTION_CALL, Order$$module$build$src$generators$python$python_generator.MEMBER],
					[Order$$module$build$src$generators$python$python_generator.FUNCTION_CALL, Order$$module$build$src$generators$python$python_generator.FUNCTION_CALL],
					[Order$$module$build$src$generators$python$python_generator.MEMBER, Order$$module$build$src$generators$python$python_generator.MEMBER],
					[Order$$module$build$src$generators$python$python_generator.MEMBER, Order$$module$build$src$generators$python$python_generator.FUNCTION_CALL],
					[Order$$module$build$src$generators$python$python_generator.LOGICAL_NOT, Order$$module$build$src$generators$python$python_generator.LOGICAL_NOT],
					[Order$$module$build$src$generators$python$python_generator.LOGICAL_AND, Order$$module$build$src$generators$python$python_generator.LOGICAL_AND],
					[Order$$module$build$src$generators$python$python_generator.LOGICAL_OR, Order$$module$build$src$generators$python$python_generator.LOGICAL_OR]
				];
				this.PASS = "";
				this.isInitialized = !1;
				for (const b in Order$$module$build$src$generators$python$python_generator) a = Order$$module$build$src$generators$python$python_generator[b], typeof a !== "string" && (this["ORDER_" + b] = a);
			...
			quote_(a) {
				...
				let b = "'";
				a.includes("'") && (a.includes("\"") ? a = a.replace(/'/g, "\\'") : b = "\"");
				return b + a + b;
			}
			multiline_quote_(a) {
			...
			getAdjustedInt(a, b, c = 0, d = !1) {
				...
				$.isNumber$$module$build$src$core$utils$string(a) ? (a = parseInt(a, 10) + c, d && (a = -a)) : (a = c > 0 ? "int(" + a + " + " + c + ")" : c < 0 ? "int(" + a + " - " + -c + ")" : "int(" + a + ")", d && (a = "-" + a));
				return a;
			}
		...
		var module$build$src$generators$python$logic = {};
		...
		var module$build$src$generators$python$loops = {};
		...
		var module$build$src$generators$python$math = {};
		...
		var module$build$src$generators$python$procedures = {};
...
//#endregion
export { Order, PythonGenerator, pythonGenerator };
